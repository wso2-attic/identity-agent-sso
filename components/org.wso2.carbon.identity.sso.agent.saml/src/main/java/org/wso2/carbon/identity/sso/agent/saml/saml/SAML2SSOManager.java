...
package org.wso2.carbon.identity.sso.agent.saml.saml;
...
import org.wso2.carbon.identity.sso.agent.saml.saml.artifact.SAMLSSOArtifactResolutionService;
        ...
        if (saml2SSOResponse != null) {
            ...
            if (samlObject instanceof LogoutResponse) {
                ...
                request.setAttribute(
                        org.wso2.carbon.identity.sso.agent.saml.util.SSOAgentConstants.SHOULD_GO_TO_WELCOME_PAGE, "true");
            } else {
